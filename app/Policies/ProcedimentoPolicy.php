...
class ProcedimentoPolicy
{
    ...
    {
        return $user->id === $procedimento->user_id;
    }
     ...
     */
    public function restore(User $user, Procedimento $procedimento): bool
    {
        return $user->id === $procedimento->user_id;
    }
     ...
     */
    public function forceDelete(User $user, Procedimento $procedimento): bool
    {
        return $user->id === $procedimento->user_id;
    }
}
