...
export default function HospitalCreate() {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        post('/hospitals', {
            onSuccess: () => toast.success('Hospital de origem criado com sucesso!'),
        });
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Novo Hospital de Origem" />

            <div className="flex flex-col gap-4 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Novo Hospital de Origem</h1>
                        <p className="text-muted-foreground">
                            Adicione um novo hospital de origem ao catálogo
                        </p>
                    </div>
                </div>
