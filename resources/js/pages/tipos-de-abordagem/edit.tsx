...
import { type TipoDeAbordagem } from '@/types/models';
import { useForm } from '@inertiajs/react';
import { ArrowLeft, Save } from 'lucide-react';
import { toast } from 'react-toastify';

interface TipoDeAbordagemEditProps {
...
export default function TipoDeAbordagemEdit({ tipo }: TipoDeAbordagemEditProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Editar Tipo de Abordagem" />
            ...
            <div className="p-4 md:p-6">
                ...
                <Card className="max-w-2xl mx-auto">
                    <form onSubmit={handleSubmit}>
                        <CardHeader>
                            <CardTitle>Editar Tipo de Abordagem</CardTitle>
                        </CardHeader>
