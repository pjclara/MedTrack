...
export default function ZonaAnatomicaCreate() {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        post('/zona-anatomicas', {
            onSuccess: () => toast.success('Zona anatómica criada com sucesso!'),
        });
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Nova Zona Anatómica" />

            <div className="flex flex-col gap-4 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Nova Zona Anatómica</h1>
                        <p className="text-muted-foreground">
                            Adicione uma nova zona anatómica ao catálogo
                        </p>
                    </div>
                </div>
