...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nova Formação', href: '#' },
];

export default function CreateFormacao() {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        router.post('/formacoes', data as any, {
            onSuccess: () => {
                toast.success('Formação criada com sucesso!');
            },
            onError: (errors) => {
                toast.error('Erro ao criar formação. Verifique os dados.');
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Registe um novo congresso, workshop, curso ou certificado
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Preencha as informações da formação</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            {/* Tema da Apresentação (condicional) */}
                            ...
                            {/* Certificado */}
                            <div className="space-y-2">
                                <Label htmlFor="certificado">Certificado (PDF, JPG, PNG - Máx. 10MB)</Label>
                    ...
                    <div className="mt-4 flex items-center justify-end gap-4">
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => router.visit('/formacoes')}
                        >
