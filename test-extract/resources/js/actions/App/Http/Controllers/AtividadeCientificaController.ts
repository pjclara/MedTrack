...
const AtividadeCientificaController = { exportMethod, index, create, store, show, edit, update, destroy, download, export: exportMethod }

export default AtividadeCientificaController